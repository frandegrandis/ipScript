...
class PageLoadIP(Page):
    ...
    def setTextBoxWidget(self):
        ...
        label1.place(x=17, y=120)

        self.inputTxt = Text(self, bg="#FAFAFA", height=10)
        self.inputTxt.place(x=20, y=150)
